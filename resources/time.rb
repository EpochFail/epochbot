class Time
  ...
  def time_ago_in_words
    Time.distance_of_time_in_words self, Time.now
  end

  def time_from_now_in_words
    Time.distance_of_time_in_words Time.now, self
  end

  def self.distance_of_time_in_words(t1, t2)
    seconds = t2 - t1
